...
cd alproot && ./alproot.sh -b /tmp/matryoshka qemu-system-x86_64 -m 4096 -netdev user,id=vm0 -device e1000,netdev=vm0 -boot d -hda /tmp/matryoshka/hda.qcow2 -nographic -smp $(nproc)
